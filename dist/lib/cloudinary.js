...
var uploadToCloud = (exports.uploadToCloud = function (filename) {
    return new Promise(function (resolve, reject) {
        cloudinary_1.default.v2.uploader.upload(filename, function (result) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, Promise.all(filenames.map(uploadToCloud))];
                case 1:
                    result = _a.sent();
